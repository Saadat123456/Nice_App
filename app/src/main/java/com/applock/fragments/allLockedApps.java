 ...
 * {@link allLockedApps.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link allLockedApps#newInstance} factory method to
 * create an instance of this fragment.
 */
public class allLockedApps extends Fragment {
     ...
     * @return A new instance of fragment allLockedApps.
     */
    // TODO: Rename and change types and number of parameters
    public static allLockedApps newInstance(String param1, String param2) {
        allLockedApps fragment = new allLockedApps();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_all_locked_apps, container, false);
        GridView lockedGrid = v.findViewById(R.id.gridViewLockedApps);
        lockedAppList = getLockedApps();
        gridViewAdapter = new gridviewAdapter(context,lockedAppList);
        lockedGrid.setAdapter(gridViewAdapter);

        return v;
    }

    private List<AppItem> getLockedApps() {
